import pytest
from src.rpsls_simple import Game, GameResult, GameAction
...
def test_draw(game):
    ...
    assert GameResult.Tie == game.assess_game(
        user_action=GameAction.Spock, computer_action=GameAction.Spock
    )

    assert GameResult.Tie == game.assess_game(
        user_action=GameAction.Lizard, computer_action=GameAction.Lizard
    )
...
def test_spock_loses(game):
    ...
    assert GameResult.Victory == game.assess_game(
        user_action=GameAction.Paper, computer_action=GameAction.Spock
    )

    assert GameResult.Victory == game.assess_game(
        user_action=GameAction.Lizard, computer_action=GameAction.Spock
    )
...
def test_spock_wins(game):
    ...
    assert GameResult.Defeat == game.assess_game(
        user_action=GameAction.Rock, computer_action=GameAction.Spock
    )

    assert GameResult.Defeat == game.assess_game(
        user_action=GameAction.Scissors, computer_action=GameAction.Spock
    )
...
def test_lizard_loses(game):
    ...
    """
    assert GameResult.Victory == game.assess_game(
        user_action=GameAction.Rock, computer_action=GameAction.Lizard
    )

    assert GameResult.Victory == game.assess_game(
        user_action=GameAction.Scissors, computer_action=GameAction.Lizard
    )
...
def test_lizard_wins(game):
    ...
    """
    assert GameResult.Defeat == game.assess_game(
        user_action=GameAction.Spock, computer_action=GameAction.Lizard
    )

    assert GameResult.Defeat == game.assess_game(
        user_action=GameAction.Paper, computer_action=GameAction.Lizard
    )
...
def test_rock_loses(game):
    ...
    """
    assert GameResult.Victory == game.assess_game(
        user_action=GameAction.Spock, computer_action=GameAction.Rock
    )
...
def test_rock_wins(game):
    ...
    assert GameResult.Defeat == game.assess_game(
        user_action=GameAction.Lizard, computer_action=GameAction.Rock
    )
...
def test_paper_loses(game):
    ...
    assert GameResult.Victory == game.assess_game(
        user_action=GameAction.Lizard, computer_action=GameAction.Paper
    )
...
def test_paper_wins(game):
    ...
    assert GameResult.Defeat == game.assess_game(
        user_action=GameAction.Spock, computer_action=GameAction.Paper
    )
...
def test_scissors_loses(game):
    ...
    """
    assert GameResult.Victory == game.assess_game(
        user_action=GameAction.Spock, computer_action=GameAction.Scissors
    )
...
def test_scissors_wins(game):
    ...
    """
    assert GameResult.Defeat == game.assess_game(
        user_action=GameAction.Lizard, computer_action=GameAction.Scissors
    )
...
def test_minus_action():
    ...
    assert 1 == len(
        GameAction.minus(
            GameAction.Scissors, GameAction.Lizard, GameAction.Paper, GameAction.Rock
        )
    )
